...
/**
 * Class Tik_Customize_Dimensions_Control
 */
class Tik_Customize_Dimensions_Control extends Tik_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'tik-dimensions';

	/**
	 * Tik_Customize_Dimensions_Control constructor.
	 *
	...
	public function localize_script() {
		...
		wp_localize_script( 'tik-controls', 'dimensionstikL10n', $this->l10n() );
	...
	protected function l10n() {
		return array(
			'top'    => esc_attr__( 'Top', 'tik' ),
			'right'  => esc_attr__( 'Right', 'tik' ),
			'bottom' => esc_attr__( 'Bottom', 'tik' ),
			'left'   => esc_attr__( 'Left', 'tik' ),
		);
	}
