...
$tik_footer_widgets_style = apply_filters( 'tik_footer_widgets_style', get_theme_mod( 'tik_footer_widgets_style', 'tg-footer-widget-col--four' ) );

$footer_sidebar_classes = apply_filters( 'tik_footer_sidebar_filter', array(
...
<div class="tg-footer-widget-container <?php tik_footer_widget_container_class(); ?>">
	<?php
	foreach ( $footer_sidebar_classes as $footer_sidebar_key => $footer_sidebar_class ) {
		foreach ( $footer_sidebar_class as $footer_sidebar_display ) {
			...
			if ( $footer_sidebar_key === $tik_footer_widgets_style ) {
				?>
