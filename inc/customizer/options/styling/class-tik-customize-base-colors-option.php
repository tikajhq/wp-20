...
/*========================================== STYLING > BASE ==========================================*/
if ( ! class_exists( 'Tik_Customize_Base_Colors_Option' ) ) :

	/**
	 * Base option.
	 */
	class Tik_Customize_Base_Colors_Option extends Tik_Customize_Base_Option {
		...
		public function elements() {
			...
			$primary_color = array(
				...
				'control'   => array(
					'type'     => 'color',
					'priority' => 10,
					'label'    => esc_html__( 'Primary Color', 'tik' ),
					'section'  => 'tik_styling_base',
					'choices'  => array(
						'alpha' => true,
					),
				),
			...
			return array(
				 ...
				 */
				'tik_base_color_primary' => apply_filters( 'tik_base_color_primary_args', $primary_color ),

				/**
				 *  Styling > Base Colors > Text color.
				 */
				'tik_base_color_text'    => array(
					'output'    => array(
						array(
							'selector' => 'body',
							'property' => 'color',
				...
				'tik_base_color_border'  => array(
					...
					'control' => array(
						'type'     => 'color',
						'priority' => 30,
						'label'    => esc_html__( 'Border Color', 'tik' ),
						'section'  => 'tik_styling_base',
						'choices'  => array(
							'alpha' => true,
						),
	...
	new Tik_Customize_Base_Colors_Option();
