...
/**
 * Class Tik_Customize_Radio_Buttonset_Control
 */
class Tik_Customize_Radio_Buttonset_Control extends Tik_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'tik-radio-buttonset';
