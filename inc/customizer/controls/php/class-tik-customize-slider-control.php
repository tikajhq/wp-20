...
/**
 * Class Tik_Customize_Slider_Control
 */
class Tik_Customize_Slider_Control extends Tik_Customize_Base_Control {
	...
	protected function content_template() {
		...
		<div class="customize-control-content">
			<div class="tik-slider">
				<div id="custom-handle" class="ui-slider-handle"></div>
			</div>
			<div class="tik-slider-input">
				...
				<span class="slider-reset dashicons dashicons-image-rotate"><span
							class="screen-reader-text"><?php esc_html_e( 'Reset', 'tik' ); ?></span></span>
			</div>
		</div>
