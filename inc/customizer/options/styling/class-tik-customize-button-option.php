...
/*========================================== STYLING >  BUTTON ==========================================*/
if ( ! class_exists( 'Tik_Customize_Button_Option' ) ) :

	/**
	 * Button option.
	 */
	class Tik_Customize_Button_Option extends Tik_Customize_Base_Option {
		...
		public function elements() {
			...
			return array(
				 ...
				 */
				'tik_button_text_hover_color' => array(
					'output'    => array(
						array(
				 ...
				 */
				'tik_button_bg_hover_color'   => array(
					'output'    => array(
						array(
							'selector' => 'button:hover, input[type="button"]:hover, input[type="reset"]:hover, input[type="submit"]:hover',
							'property' => 'background-color',
	...
	new Tik_Customize_Button_Option();
