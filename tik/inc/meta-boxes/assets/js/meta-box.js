	...
	function ( $ ) {
		...
		addImgLink.on(
			...
			function ( event ) {
				...
				frame.on(
					'select',
					function () {
						var imgContainer = self.parents( '.tik-ui-field' ).find( '.tg-upload-img' ),
						    input        = self.parents( '.tik-ui-field' ).find( '.tg-upload-input' ),
		...
		delImgLink.on(
			...
			function ( event ) {
				...
				var imgContainer = $( this ).parents( '.tik-ui-field' ).find( '.tg-upload-img' ),
				    input        = $( this ).parents( '.tik-ui-field' ).find( '.tg-upload-input' ),
				    delLink      = $( this ),
		 ...
		 */
		( function () {
			var optionsEnabler = $( '#tik-menu-item-style input[type="radio"][name="tik_primary_menu_item_style"]' );
			...
			$( '#tik-menu-item-style input[type="radio"][name="tik_primary_menu_item_style"]:checked' ).click();
