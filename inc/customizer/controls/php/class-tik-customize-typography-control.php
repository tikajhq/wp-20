...
/**
 * Class Tik_Customize_Typography_Control
 */
class Tik_Customize_Typography_Control extends Tik_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'tik-typography';

	/**
	 * Tik_Customize_Typography_Control constructor.
	 *
	...
	public function localize_script() {
		...
		$localize_script_var = ( $custom_fonts_array ) ? 'tikFonts' . $this->id : 'tikAllFonts';

		wp_localize_script(
			'tik-controls', $localize_script_var, array(
	...
	public function to_json() {
		...
		$this->json['languages'] = Tik_Fonts::get_google_font_subsets();
	...
	protected function content_template() {
		...
		<div class="tik-customizer-title-wrapper toggle-title">
			<# if ( data.label ) { #>
				<span class="customize-control-title">{{ data.label }}</span>
			<# } #>

			<div class="tik-toggle-button">
				<a href="#">
					<span class="dashicons dashicons-edit"></span>
				</a>
			</div> <!-- /.tik-toggle-button -->
		</div>
		...
		<div class="tik-group-fields tik-typography-wrapper toggle-content">
			<# if ( data.default['font-family'] ) { #>
			<# data.value['font-family'] = data.value['font-family'] || data['default']['font-family']; #>

			<# if ( data.choices['fonts'] ) { data.fonts = data.choices['fonts']; } #>
			<div class="tik-single-field font-family">
				<h5 class="tik-field-title"><?php esc_html_e( 'Font family', 'tik' ); ?></h5>
				<div class="tik-field-content">
					<select {{{ data.inputAttrs }}} id="tik-typography-font-family-{{{ data.id }}}"></select>
				</div>
			</div>

			<# if ( false !== data.default.variant ) { #>
			<div class="tik-single-field variant">
				<h5 class="tik-field-title"><?php esc_attr_e( 'Variant', 'tik' ); ?></h5>
				<div class="tik-field-content">
					<select {{{ data.inputAttrs }}} id="tik-typography-variant-{{{ data.id }}}"></select>
				</div>
			</div>
			<# } #>

			<div class="tik-single-field subsets">
				<h5 class="tik-field-title"><?php esc_attr_e( 'Subset(s)', 'tik' ); ?></h5>
				<div class="tik-field-content">
					<select {{{ data.inputAttrs }}} id="tik-typography-subsets-{{{ data.id }}}"
			...
			<div class="tik-single-field font-size">
				<h5 class="tik-field-title"><?php esc_html_e( 'Font size', 'tik' ); ?></h5>
				<div class="tik-field-content">
			...
			<div class="tik-single-field color">
				<h5 class="tik-field-title"><?php esc_attr_e( 'Color', 'tik' ); ?></h5>
				<div class="tik-field-content">
					<input {{{ data.inputAttrs }}} type="text" data-palette="{{ data.palette }}" data-default-color="{{ data.default['color'] }}" value="{{ data.value['color'] }}" class="tik-color-control"/>
				</div>
			</div>
			<# } #>
			...
			<div class="tik-single-field line-height">
				<h5 class="tik-field-title"><?php esc_attr_e( 'Line Height', 'tik' ); ?></h5>
				<div class="tik-field-content">
	...
	protected function format_variants_array( $variants ) {
		...
		$all_variants   = Tik_Fonts::get_all_variants();
	...
	protected function get_standard_fonts() {
		...
		$standard_fonts = Tik_Fonts::get_standard_fonts();
	...
	protected function get_google_fonts() {
		...
		$google_fonts = Tik_Fonts::get_google_fonts();
		$all_variants = Tik_Fonts::get_all_variants();
		$all_subsets  = Tik_Fonts::get_google_font_subsets();
